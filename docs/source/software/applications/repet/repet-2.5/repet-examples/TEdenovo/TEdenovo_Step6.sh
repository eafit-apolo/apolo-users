...
# repet-examples TEdenovo - Step 6 - Combined Standard and Structural
...
if [ ! -d "${ProjectName}_${SMPL_ALIGNER}_${CLUSTERERS}_Struct_${MLT_ALIGNER}_TEclassif/classifConsensus" ]; then
    ...
    #TEdenovo.py -P $ProjectName  -C TEdenovo.cfg -S 6 -S 6 -s Blaster -c GrpRecPil -m Map
    TEdenovo.py -P $ProjectName  -C TEdenovo.cfg -S 6 -s Blaster -c GrpRecPil -m Map --struct
else

...
#SBATCH --ntasks=1     # Number of tasks (processes) for each array-step
#SBATCH --time=01:00   # Walltime for each array-step
...
srun cp ${files[$SLURM_ARRAY_TASK_ID]} copy$SLURM_ARRAY_TASK_ID
